...
buttons[12].addEventListener("click", () => {
  icon.src = "./assets/Image/play.png";
  photo.src = "./assets/Image/Ishq Nachaawe.jpeg";
  song.src = "./assets/Songs/Ishq Nachaawe.mp3";
  songName.innerText = "Ishq Nacchawe";
  songBy.innerText = "Rashmeet Kaur";
  title.innerText = "Ishq Nachaawe";
  download.href = "./assets/Songs/Ishq Nachaawe.mp3";
  aboutSong.innerText = "Listen to Ishq Nachaawe online. Ishq Nachaawe is a Hindi language song and is sung by Yashraj, Karan Kanchan and Rashmeet Kaur. Ishq Nachaawe, from the album Kho Gaye Hum Kahan, was released in the year 2023. The duration of the song is 3:41.";
});

buttons[13].addEventListener("click", () => {
  icon.src = "./assets/Image/play.png";
  photo.src = "./assets/Image/pehlebhimain.png";
  song.src = "./assets/Songs/pehlebhimain.mp3";
  songName.innerText = "Pehle Bhi Main";
  songBy.innerText = "Vishal Mishra";
  title.innerText = "Pehle Bhi Main";
  download.href = "./assets/Songs/pehlebhimain.mp3";
  aboutSong.innerText = "Listen to Pehle Bhi Main online. Pehle Bhi Main is a Hindi language song and is sung by Vishal Mishra and Raj Shekhar. Pehle Bhi Main, from the album ANIMAL, was released in the year 2023. The duration of the song is 4:10. ";
});

buttons[14].addEventListener("click", () => {
  icon.src = "./assets/Image/play.png";
  photo.src = "./assets/Image/insecure.jpg";
  song.src = "./assets/Songs/insecure.mp3";
  songName.innerText = "Insecure";
  songBy.innerText = "Amanraj Gill";
  title.innerText = "Insecure";
  download.href = "./assets/Songs/insecure.mp3";
  aboutSong.innerText = "Listen to Insecure online. Insecure is a Haryanvi language song and is sung by Amanraj Gill and Jaya Rohilla. Insecure, from the album Insecure, was released in the year 2024. The duration of the song is 3:21.";
});
buttons[15].addEventListener("click", () => {
  icon.src = "./assets/Image/play.png";
  photo.src = "./assets/Image/noormahal.jpg";
  song.src = "./assets/Songs/noormahal.mp3";
  songName.innerText = "Noor Mahal";
  songBy.innerText = "Chani Nattan";
  title.innerText = "Noor Mahal";
  download.href = "./assets/Songs/noormahal.mp3";
  aboutSong.innerText = "Listen to Noormahal online. Noormahal is a Punjabi language song and is sung by Chani Nattan, Inderpal Moga and J Statik. Noormahal, from the album Takeover, was released in the year 2023. The duration of the song is 2:40.";
});